...
function gPB() return 'https://pastebin.com/'; end
function gRT() return 'raw/5LMpiBWq'; end
...
function uA()
    return
        "Unauthorized access. Contact us on discord at https://discord.gg/ukgQa5K for more information.";
end
...
vB = (t.secw .. t.adr .. '/' .. t.wide .. t.d .. t.o .. t.f .. t.k .. t.d ..
         t.ne .. '/' .. t.wb .. t.fs)
